...
import { FiAward, FiBookOpen, FiCalendar, FiMapPin, FiGraduationCap } from "react-icons/fi";
  ...
  const educationData = [
    {
      ...
      endYear: 2025,
      cgpa: "8.1",
      description: "Advanced studies in computer science with focus on software development, database management, and modern technologies.",
      highlights: [
      ...
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Truba-college.jfif-grB3QOttLo4RYtV468tcXOS1apR6JJ.jpeg",
    ...
    },
    {
      ...
      image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Raja-Shankar-Shah-University-i4yW0UrL8Uoj1pNRgCuNPA5vW4jGkM.png",
        ...
        <GlassmorphicCard className="overflow-hidden h-full hover:border-primary/50 transition-all duration-300">
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <div className="absolute top-4 right-4">
              ...
              >
                <FiGraduationCap className="w-4 h-4" />
                {edu.status}
              </motion.span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="p-3 rounded-lg bg-primary/10">
                <FiGraduationCap className="w-6 h-6 text-primary" />
              </div>
              <div>
